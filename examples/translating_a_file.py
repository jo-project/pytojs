...
# there are 2 easy methods to run js file from pytojs

# Method 1:
eval_result, example = pytojs.run_file('example.js')


# Method 2:
pytojs.translate_file('example.js', 'example.py') # this translates and saves equivalent Py file
